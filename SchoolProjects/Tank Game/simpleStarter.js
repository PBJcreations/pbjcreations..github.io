...
function main() {
  ...
  allScenes.push(titleScene);
   ...
   allScenes.push(arena2);
   allScenes.push(arena3);
   allScenes.push(arena4);
   allScenes.push(arena5);
  ...
  var wall = new GameObject("WallT", "wall");
    ...
    var wall = new GameObject("smallSQ", "wall");
    wall.transform.position = new Vector2(0, 0);
    wall.transform.rotation = 0;
    var wallGeometry = new AxisAlignedRectangle(1.5, 1.5);
    wall.components.push(new GeometryComponent(wallGeometry));
    ...
    var wall = new GameObject("mediumSQ", "wall");
    wall.transform.position = new Vector2(0, 0);
    wall.transform.rotation = 0;
    var wallGeometry = new AxisAlignedRectangle(2.5, 2.5);
    wall.components.push(new GeometryComponent(wallGeometry));
    var wallRenderer = new GeometryRendererComponent("dimgray", wallGeometry);
    wall.components.push(wallRenderer);
    wall.renderer = wallRenderer;
    ...
    var wall = new GameObject("medRSQ", "wall");
    wall.transform.position = new Vector2(0, 0);
    wall.transform.rotation = 0;
    var wallGeometry = new AxisAlignedRectangle(2.5, 2.5);
    wall.components.push(new GeometryComponent(wallGeometry));
    ...
    var wall = new GameObject("thin45", "wall");
    wall.transform.position = new Vector2(0, 0);
